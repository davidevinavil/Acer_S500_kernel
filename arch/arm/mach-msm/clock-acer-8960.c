...
static void __init msm8960_clock_init(void)
{
	...
	/*
	 * Set the I2C gsbi rates to a default to avoid warning message.
	 * The rates must set same values which is
	 * msm_i2c_latform_data.src_clk_rate in board-acer-8960.c.
	 */
...
EXPORT_SYMBOL(debug_dump_all_active_clocks);
