...
enum {
	...
	MSM_RPM_STATUS_ID_QDSS_CLK				= 125,
	MSM_RPM_STATUS_ID_WAKEUP_INTS_0				= 126,
	MSM_RPM_STATUS_ID_WAKEUP_INTS_1 			= 127,
	MSM_RPM_STATUS_ID_IN_ACTIVE_CORES 			= 128,
	MSM_RPM_STATUS_ID_CORE0_SLEEP_COUNT 			= 129,	/* APSS */
	MSM_RPM_STATUS_ID_CORE1_SLEEP_COUNT 			= 130,	/* MPSS SW */
	MSM_RPM_STATUS_ID_CORE2_SLEEP_COUNT 			= 131,	/* LPASS */
	MSM_RPM_STATUS_ID_CORE3_SLEEP_COUNT 			= 132,	/* RIVA */
	MSM_RPM_STATUS_ID_CORE4_SLEEP_COUNT 			= 133,	/* DSPS */
	MSM_RPM_STATUS_ID_CORE5_SLEEP_COUNT 			= 134,	/* MPSS FW */

	MSM_RPM_STATUS_ID_LAST = MSM_RPM_STATUS_ID_CORE5_SLEEP_COUNT,
#else
