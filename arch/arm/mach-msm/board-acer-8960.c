...
#include "board-acer-8960-touch.h"
#endif
...
#define MSM8960_FIXED_AREA_START 0xab000000
#else
 ...
 */
#ifdef CONFIG_MACH_ACER_A9
static unsigned long fixed_high_start;
#endif
...
//	gpio_direction_input(NXP_PN544_INTR);

//	gpio_direction_output(NXP_PN544_FW_DW, 0);
...
/*
 * If changing value of src_clk_rate must also change clk_set_rate() in clock-acer-8960.c
 */
