...
{
	uint16_t ad5823_hw_params = *(uint16_t *)hwparams;
	uint8_t ad5823_ring_ctrl = (ad5823_hw_params & 0x100) >> 6;
	...
	CDBG("%s ad5823_vcm_step_time:0x%x next_lens_position:%d, msb:0x%x lsb:0x%x\n",
		__func__, ad5823_hw_params, next_lens_position, msb, lsb);
...
static uint16_t ad5823_vcm_step_time[] = {
	0x000,
	0x115,
};

static uint16_t ad5823_macro_scenario[] = {
	/* MOVE_NEAR dir*/
...
static struct region_params_t ad5823_regions[] = {
	...
	/* Region 2 */
	{
		.step_bound = {AD5823_TOTAL_STEPS_NEAR_TO_FAR_MAX, 2},
		.code_per_step = 9,
	}
};

static struct damping_params_t ad5823_macro_damping_reg1[] = {
	/* scenario 1 => Damping params */
	{
		.damping_step = 0xFF,
		.damping_delay = 200,
		.hw_params = &ad5823_vcm_step_time[0],
	},
};

static struct damping_params_t ad5823_macro_damping_reg2[] = {
	/* scenario 1 => Damping params */
	{
		.damping_step = 0xFF,
		.damping_delay = 6000,
		.hw_params = &ad5823_vcm_step_time[1],
	},
};

static struct damping_params_t ad5823_inf_damping_reg1[] = {
	/* scenario 1 => Damping params */
	{
		.damping_step = 0xFF,
		.damping_delay = 200,
...
static struct damping_params_t ad5823_inf_damping_reg2[] = {
	/* scenario 1 => Damping params */
	{
		.damping_step = 0xFF,
		.damping_delay = 12000,
...
static struct damping_t ad5823_macro_region_damp_params[] = {
	/* Region 1 */
	{
		.ringing_params = ad5823_macro_damping_reg1,
	},
	/* Region 2 */
	{
		.ringing_params = ad5823_macro_damping_reg2,
	},
};

static struct damping_t ad5823_inf_region_damp_params[] = {
	/* Region 1 */
{
		.ringing_params = ad5823_inf_damping_reg1,
	},
	/* Region 2 */
	{
		.ringing_params = ad5823_inf_damping_reg2,
	},
};
...
static int32_t ad5823_set_params(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	msm_camera_i2c_write(&a_ctrl->i2c_client, AD5823_REG_VCM_MOVE_TIME,
		ad5823_vcm_step_time[1] & 0xFF, MSM_CAMERA_I2C_BYTE_DATA);
	return 0;
}
...
static struct msm_actuator_ctrl_t ad5823_act_t = {
	...
	/* Initialize scenario */
	.ringing_scenario[MOVE_NEAR] = ad5823_macro_scenario,
	.scenario_size[MOVE_NEAR] = ARRAY_SIZE(ad5823_macro_scenario),
	...
	.damping[MOVE_NEAR] = ad5823_macro_region_damp_params,
	.damping[MOVE_FAR] = ad5823_inf_region_damp_params,
	...
	.get_info = {
		.focal_length_num = 369,
		.focal_length_den = 100,
		.f_number_num = 22,
		.f_number_den = 10,
		.f_pix_num = 14,
		.f_pix_den = 10,
		.total_f_dist_num = 221041,
		.total_f_dist_den = 1000,
		.hor_view_angle_num = 631,
