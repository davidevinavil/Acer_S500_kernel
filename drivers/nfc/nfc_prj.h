...
enum nfc_drv_op_e {
	stop_nfc_test = 0x30,
	check_mode_status = 0x31,
	enable_nfc_hci_mode = 0x32,
	enable_nfc_dl_mode = 0x33,
	disable_nfc = 0x34,
	set_hci_active_mode = 0x35,
	set_hci_standby_mode = 0x36,
	act_emu_card_mode = 0x37,
	act_read_ver = 0x38,
	act_read_card_id = 0x39,
	act_reg_read = 0x61, /* 'a' */
...
extern void Nfc_Prj_EnableProc(void);
extern void Nfc_Prj_DisableProc(void);
extern int NFC_DrvOp(enum nfc_drv_op_e eNfcDrvTestItem, void * pvInOutBuf);
